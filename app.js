...
app.get("/posts/:reqTitle", (req, res) => {
  const reqTitleKebab = _.kebabCase(req.params.reqTitle);
  posts.forEach( (post) => {
    const storedTitleKebab = _.kebabCase(post.postTitle);
    if (storedTitleKebab === reqTitleKebab) {
